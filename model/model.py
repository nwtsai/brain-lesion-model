...
authors = "Nathan Tsai, Bradley Zhu"
title = "Model Results"
...
def append_index(filesets, step=False):
    ...
    if os.path.exists(index_path):
                ...
                "<body>" + 
                    "<div class='navbar-fixed'>" + 
                        "<nav role='navigation'><div class='nav-wrapper'>" + 
                            "<a href='#' class='brand-logo left title'>" + title + "</a>" + 
                            "<a href='#' class='brand-logo right authors'>" + authors + "</a>" + 
                        "</div></nav>" + 
                    "</div>"
        )
        ...
        index.write(
            "<th>Filename</th>" + 
            "<th>Input Brain Scans</th>" + 
            "<th>Model's Guess</th>" + 
            "<th>Actual Isolated Lesion</th>" + 
            "<th>Model Accuracy</th></tr>"
        )
    ...
    for fileset in filesets:
        ...
        index.write("<td>" + fileset["name"] + "-accuracy</td></tr>")
